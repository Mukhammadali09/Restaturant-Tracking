...
const TRANSLATIONS = {
  en: {
    ...
    msg_upload_fail: "Upload failed: {0}. If using PDF, try uploading as photos instead.",
    msg_no_selected: "No items selected",
    msg_saved_items: "Saved {0} items!",
    msg_ocr_saved: "Added {0} items to {1}. Edit them in the menu table below.",
  ...
  ru: {
    ...
    msg_upload_fail: "Ошибка загрузки: {0}. Если PDF не работает, попробуйте загрузить как фото.",
    msg_no_selected: "Ничего не выбрано",
    msg_saved_items: "Сохранено {0} позиций!",
    msg_ocr_saved: "Добавлено {0} позиций в {1}. Редактируйте в таблице меню ниже.",
